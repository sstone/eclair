...
private[channel] object ChannelCodecs2 {
  ...
  private[version2] object Codecs {
    ...
    val claimHtlcTimeoutTxCodec: Codec[ClaimHtlcTimeoutTx] = (("inputInfo" | inputInfoCodec) :: ("tx" | txCodec) :: ("htlcId" | uint64overflow) :: provide(ByteVector32.Zeroes) :: provide(CltvExpiry(0)) :: ("confirmationTarget" | defaultConfirmationTarget)).as[ClaimHtlcTimeoutTx] // FIXME
